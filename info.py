...
API_ID = int(environ.get('API_ID', '22170153'))
API_HASH = environ.get('API_HASH', '12bca0eb06693f1d2d8a0afd94bf5dda')
BOT_TOKEN = environ.get('BOT_TOKEN', "7534914080:AAE2W4g9chhsHLbscCG11cc9i1C67yvk3wA")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7447449953 7740959630 7534914080 7501899331').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7447449953 7740959630 7534914080 7501899331').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002589726012'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002163606331').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-4963565713') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4963078720')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELs', '-1002711972922').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Walter:EdaisrUxVz1oC1TD@cluster0.irgkjpy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+EoDXFaWeLvAzYmM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movieniraye')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+ry9M-yPRSelkZjM1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Aslam Muhammed')
